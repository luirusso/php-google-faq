...
<body>
    ...
    <header class="d-flex align-items-center position-fixed w-100">
      <nav class="px-3">
        <div class="pb-3">
          <a href="#"><img src="./img/googlelogo_clr_74x24px.svg" alt=""></a>
          <span class="fs-4">
            Privacy e termini
          </span>
        </div>
        <div>
          <ul class="d-flex">
            <li><a class="gray" href="#">Introduzione</a></li>
            <li><a class="gray" href="#">Norme sulla privacy</a></li>
            <li><a class="gray" href="#">Termini di servizio</a></li>
            <li><a class="gray" href="#">Tecnologie</a></li>
            <li><a class="gray active_site" href="#">Domande frequenti</a></li>
          </ul>
        </div>
      </nav>
    </header>
    ...
    <div class="container padding_top">
        <main>
            ...
            <h3 class="pb-3"><?php echo $faq['question'] ?></h3>
            <?php echo $faq['answer']; ?>
            <?php } ?>
        </main>
    </div>
    ...
    <footer>
      <div class="container d-flex justify-content-between align-items-center">
        <div>
          <ul class="d-flex">
            <li><a class="white" href="#">Google</a></li>
            <li><a class="white" href="#">Tutto su Google</a></li>
            <li><a class="white" href="#">Privacy</a></li>
